...
func TestLinearSortedEngine_AddData(t *testing.T) {
	...
	var tests = []struct {
		...
		{name: "test1", data: " the golang is quick  Golang compilation Golang and execution speed;", IdDoc: 1,
			expected: []TermInfo{
				{"compilation", 1, 1}, {"execution", 1, 1}, {"golang", 1, 3}, {"is", 1, 1},
				{"quick", 1, 1}, {"speed", 1, 1},
			}},
		...
		{name: "test3", data: " the Golang is interfaces Golang enable Loosely couPled Golang systems;", IdDoc: 30,
			expected: []TermInfo{
				{"coupled", 30, 1}, {"enable", 30, 1}, {"golang", 30, 3}, {"interfaces", 30, 1}, {"is", 30, 1},
				{"loosely", 30, 1}, {"systems", 30, 1},
			}},
		{name: "test4", data: " the Golang is interfaces Golang enable Loosely Golang couPled Golang systems Golang;", IdDoc: 310,
			expected: []TermInfo{

				{"coupled", 310, 1}, {"enable", 310, 1}, {"golang", 310, 5}, {"interfaces", 310, 1}, {"is", 310, 1},
				{"loosely", 310, 1}, {"systems", 310, 1},
			}},
	}
...
func TestLinearSortedEngine_Search(t *testing.T) {
	var tests = []struct {
		name       string
		data       string
		IdDoc      int
